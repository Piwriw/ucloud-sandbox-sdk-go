...
const file_filesystem_filesystem_proto_rawDesc = "" +
	...
	"\rRemoveWatcher\x12 .filesystem.RemoveWatcherRequest\x1a!.filesystem.RemoveWatcherResponseB\xa6\x01\n" +
	"\x0ecom.filesystemB\x0fFilesystemProtoP\x01Z;github.com/ucloud/ucloud-sandbox-sdk-go/pkg/envd/filesystem\xa2\x02\x03FXX\xaa\x02\n" +
	"Filesystem\xca\x02\n" +
